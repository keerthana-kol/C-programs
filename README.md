...
This folder contains beginner-level C programs that cover fundamental concepts such as input/output, arithmetic operations, and simple problem solving.  
These programs are useful for **college labs**, **practice**, and **building strong C fundamentals**.
